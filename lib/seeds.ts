...
export const SEED_MENU: {
  ...
  { night: "Friday", meal: "Dinner", dish: "Burgers + dogs", notes: "", sort: 2, veg: false, votable: true },
  { night: "Friday", meal: "Dinner", dish: "Chili", notes: "", sort: 3, veg: false, votable: true },
  { night: "Friday", meal: "Dinner", dish: "Sausage + peppers", notes: "", sort: 4, veg: false, votable: true },
...
// Quantities for eleven over three days. Mirrors migration 0028 — the list is
// only useful if the menu feeds it, and only right if the menu is cookable.
