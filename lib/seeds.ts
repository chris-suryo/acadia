...
export const SEED_BLOCKS: {
  ...
  { day_id: "fri", title: "Check in — sites B080 + B082", detail: "side by side on the B loop", day_part: "afternoon", link_slug: null, sort: 2 },
  { day_id: "fri", title: "Camp setup", detail: "tents, kitchen, tarp — first crew starts", day_part: "afternoon", link_slug: null, sort: 3 },
  { day_id: "fri", title: "Firewood, ice, water", detail: "wood on the island only · spigots at camp for refills", day_part: "afternoon", link_slug: null, sort: 4 },
  { day_id: "fri", title: "Cook dinner at camp", detail: "menu's on the Food tab", day_part: "evening", link_slug: null, sort: 5 },
  { day_id: "fri", title: "Campfire, plan Saturday", detail: "food sleeps in cars · quiet hours at 10", day_part: "evening", link_slug: null, sort: 6 },
  { day_id: "sat", title: "Breakfast, pick the plan", detail: "which hikes, who's going where", day_part: "morning", link_slug: null, sort: 1 },
  { day_id: "sat", title: "Shuttle or cars", detail: "Route 10 stops at the campground", day_part: "morning", link_slug: "shuttle", sort: 2 },
  { day_id: "sat", title: "Out in the park", detail: "pick from the options below", day_part: "afternoon", link_slug: "beehive", sort: 3 },
